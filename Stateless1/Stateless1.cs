...
namespace Stateless1
{
    ...
    /// </summary>
    internal sealed class Stateless1 : StatelessService, IStateless
    {
        ...
        protected override async Task RunAsync(CancellationToken cancellationToken)
        {
            ...
            while (true)
            {
                ...
                ServiceEventSource.Current.ServiceMessage(this, "Working-{0}", ++_iterations);

                await Task.Delay(TimeSpan.FromSeconds(1), cancellationToken);
            }
        }

        public async Task<long> GetCurrentValue()
        {
            return _iterations;
        }
    }
